/* Блок: Конфигурация и объект прелоадера */
const loadScreen = {
  ...
  /* Блок: Создание сетки загрузочного экрана (вертикальные и горизонтальные линии) */
  createGrid: function() {
  ...
  /* Блок: Анимация текста (h1) загрузки и появление по буквам */
  loadText: () => {
  ...
  /* Блок: Обработчик изменения размера окна для перерисовки сетки */
